    ...
    <div className="dashboard-root">
      ...
      <main className="dashboard-main">
        <div className="dashboard-header">
          <div>
            <h1>Bienvenido/a, <span className="dashboard-user">{user?.first_name || user?.username}</span></h1>
        ...
        {/* Puedes seguir con widgets abajo, como "Resumen de Ventas", "Actividad Reciente", etc. */}
